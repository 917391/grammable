...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#create action" do
    ...
    it "should successfully create a new gram into our database" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    ...
    it "should have http 404 message if the gram cannot be found" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "gram#delete action" do
    it "shouldn't let a user who did not create the gram delete the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "should return a 404 message if we cannot find a gram with the id that is specified " do
      user = FactoryBot.create(:user)
      sign_in user
      delete :destroy, params: { id: 'SpaceQuack' }
      expect(response).to have_http_status(:not_found)
    end
  end
end
